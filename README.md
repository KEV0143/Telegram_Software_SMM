...
Демонстрация отображения базы данных после работы модуля, изменились столбцы: `Первое сообщение, Обработано сессией, Статус сообщения, Дата отправки, Отправленное сообщение`
