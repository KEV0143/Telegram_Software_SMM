...
Этот режим предназначен для целевой коммуникации. Он позволяет отправить сообщение конкретному пользователю, выбрав его из
списка или указав контактные данные вручную. Функция удобна для повторной связи, отправки персонализированных предложений и ответов на запросы.
...
![image](https://github.com/user-attachments/assets/d6ea6f1d-abb4-4a45-a90e-1947a818bb6e)
...
![image](https://github.com/user-attachments/assets/d1e863b3-4407-48b1-a99f-fd5043304f56)

**2. Проверка на спам-блок**
Автоматизированная проверка статуса аккаунта на наличие ограничений через официального `@SpamBot`.
![image](https://github.com/user-attachments/assets/a69ecf3f-aa4f-4eee-b31e-2ac6d13cdcca)

**3. Проверка статуса аккаунта**
Определение, является ли аккаунт активным или был удален (заблокирован) платформой Telegram.
![image](https://github.com/user-attachments/assets/7ddf4273-4d6b-4035-a4ca-6487d9b5b013)
