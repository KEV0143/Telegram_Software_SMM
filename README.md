...
1. **Запустить рассылку первых сообщений**
...
1.1 **Демонстрация отображения базы данных после работы модуля**, изменились столбцы: `Первое сообщение, Обработано сессией, Статус сообщения, Дата отправки, Отправленное сообщение`

![image](https://github.com/user-attachments/assets/4c53dde6-1a8b-446b-b37e-b4d16feb2135)

2. **Отправить сообщение только одному пользователю**
